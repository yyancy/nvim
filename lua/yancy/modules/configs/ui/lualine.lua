return function()
	local colors = require("yancy.modules.utils").get_palette()
	local icons = {
	...
	local winbar_bg = require("yancy.modules.utils").hl_to_rgb("StatusLine", true, colors.mantle)
	for _, hlGroup in pairs(require("lspsaga.lspkind").get_kind_group()) do
		require("yancy.modules.utils").extend_hl(hlGroup, { bg = winbar_bg })
	end
end
