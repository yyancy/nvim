...
local settings = require("yancy.core.settings")
local use_ssh = settings.use_ssh

local icons = {
	kind = require("yancy.modules.utils.icons").get("kind"),
	documents = require("yancy.modules.utils.icons").get("documents"),
	ui = require("yancy.modules.utils.icons").get("ui"),
	ui_sep = require("yancy.modules.utils.icons").get("ui", true),
	misc = require("yancy.modules.utils.icons").get("misc"),
}
...
function Lazy:load_plugins()
	...
	local append_nativertp = function()
		package.path = package.path
			.. string.format(";%s;%s;%s", vim_path .. "/lua/yancy/?.lua" ,modules_dir .. "/configs/?.lua", modules_dir .. "/configs/?/init.lua")
			-- .. string.format("%s", vim_path .. "/lua/yancy/?.lua")
	end
...
function Lazy:load_lazy()
    ...
    dev = {
      path ="/home/yancy/.config/nvim/tmp/local"
    },
		ui = {
